...
for i in range(1, 5):
    ...
    soma_idade = soma_idade + idade # para fazer a média de idades do grupo, soma todas as idade e divide por 4
...
print("A média de iadade do grupo é de: {} anos.".format(media_idade))
